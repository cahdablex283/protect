...
def youtubeMp3(to, link):
    subprocess.getoutput('youtube-dl --extract-audio --audio-format mp3 --output cannibal.mp3 {}'.format(link))
    try:
            ...
            if Fmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ginfo = bu.getGroup(op.param1)
                        bu.leaveGroup(op.param1)
                    else:
                        bu.acceptGroupInvitation(op.param1)
                        ginfo = bu.getGroup(op.param1)
            if Gmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ginfo = bi.getGroup(op.param1)
                        bi.leaveGroup(op.param1)
                    else:
                        bi.acceptGroupInvitation(op.param1)
                        ginfo = bi.getGroup(op.param1)
            if Hmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ginfo = bo.getGroup(op.param1)
                        bo.leaveGroup(op.param1)
                    else:
                        bo.acceptGroupInvitation(op.param1)
                        ginfo = bo.getGroup(op.param1)
            if Imid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ginfo = ba.getGroup(op.param1)
                        ba.leaveGroup(op.param1)
                    else:
                        ba.acceptGroupInvitation(op.param1)
                        ginfo = ba.getGroup(op.param1)
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(KAC).inviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        ko.kickoutFromGroup(op.param1,[op.param2])
                                        ko.inviteIntoGroup(op.param1,[op.param3])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(ABC).inviteIntoGroup(op.param1,[mid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        jk.kickoutFromGroup(op.param1,[op.param2])
                                        jk.inviteIntoGroup(op.param1,[op.param3])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        bu.kickoutFromGroup(op.param1,[op.param2])
                                        bu.inviteIntoGroup(op.param1,[op.param3])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        bi.kickoutFromGroup(op.param1,[op.param2])
                                        bi.inviteIntoGroup(op.param1,[op.param3])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        bo.kickoutFromGroup(op.param1,[op.param2])
                                        bo.inviteIntoGroup(op.param1,[op.param3])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    sw.updateGroup(G)
                                    sw.leaveGroup(op.param1)
                                    random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Fmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                except:
                                    try:
                                        ba.kickoutFromGroup(op.param1,[op.param2])
                                        ba.inviteIntoGroup(op.param1,[op.param3])
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            ko.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            jk.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            bu.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            bi.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            bo.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            ba.acceptGroupInvitationByTicket(op.param1,Ticket)
                                                            random.choice(ABC).kickoutFromGroup(op.param1,[op.param2])
                                                            random.choice(ABC).inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,EmidFmid,Gmid,Hmid,Imid,Jmid,Zmid])
                                                            X = ba.getGroup(op.param1)
                                                            ba.updateGroup(X)
                                                            X.preventedJoinByTicket = True
                                                            ba.inviteIntoGroup(op.param1,[Zmid])
  ...
  "contents": [
    {
      ...
      "body": {
        ...
        "contents": [
          {
            "type": "image",
            "url": "https://h.top4top.io/p_1468dxeug0.jpg",
            "size": "full",
            "aspectMode": "cover",
            "aspectRatio": "1:1",
            "gravity": "top"
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                        if Amid in Setmain["RAfoto"]:
                            ...
                            ba.sendMessage(msg.to,"🔹ғᴏᴛᴏ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     bu.sendMessage(msg.to, "🔹ғᴏᴛᴏ ʙᴏᴛ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
                     bi.updateProfilePicture(path7)
                     bi.sendMessage(msg.to, "🔹ғᴏᴛᴏ ʙᴏᴛ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
                     bo.updateProfilePicture(path8)
                     bo.sendMessage(msg.to, "🔹ғᴏᴛᴏ ʙᴏᴛ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
                     ba.updateProfilePicture(path9)
                     ba.sendMessage(msg.to, "🔹ғᴏᴛᴏ ʙᴏᴛ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
                     be.updateProfilePicture(path10)
                     be.sendMessage(msg.to, "🔹ғᴏᴛᴏ ʙᴏᴛ ᴅᴏɴᴇ ᴅɪ ʀᴜʙᴀʜ")
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    kg.leaveGroup(i)
                                    kh.leaveGroup(i)
                                    sendTextTemplate(msg.to,"🔹ᴅᴏɴᴇ ᴋᴇʟᴜᴀʀ ɢʀᴜᴘ" +str(ginfo.name))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                bu.sendMessage(msg.to,"🔹ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ")                                
                                
                        elif cmd == "cp7":
                            if msg._from in admin:
                                Setmain["RAfoto"][Gmid] = True
                                bi.sendMessage(msg.to,"🔹ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ")                                
                                
                        elif cmd == "cp8":
                            if msg._from in admin:
                                Setmain["RAfoto"][Hmid] = True
                                bo.sendMessage(msg.to,"🔹ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ")                                
                                
                        elif cmd == "cp9":
                            if msg._from in admin:
                                Setmain["RAfoto"][Imid] = True
                                ba.sendMessage(msg.to,"🔹ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ")                                
                                
                        elif cmd == "cp10":
                            if msg._from in admin:
                                Setmain["RAfoto"][Jmid] = True
                                be.sendMessage(msg.to,"🔹ᴋɪʀɪᴍ ғᴏᴛᴏɴʏᴀ")                                
                          ...
                          if msg._from in admin:
                            ...
                            string = msg.text.replace(separate[0] + " ","")
                            if len(string) <= 10000000000:
                                profile = jk.getProfile()
                                profile.displayName = string
                                jk.updateProfile(profile)
                                jk.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                bu.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                bi.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                bo.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ba.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                be.sendMessage(msg.to,"🔹ɴᴀᴍᴀ ᴅɪ ɢᴀɴᴛɪ ᴊᴀᴅɪ " + string + "")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sendTextTemplate(msg.to,"🔹ʟɪsᴛ ʙᴏᴛ\n\n"+ma+"\n🔹Total Bot Cannibal「%s」" %(str(len(Bots))))
                          ...
                          if msg._from in admin:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "🔹ᴘᴀᴘᴀʏ sᴇᴍᴜᴀ ɴʏᴀ")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                                        ko.leaveGroup(i)            
                                        ...
                                        bo.leaveGroup(i)
                                        ba.leaveGroup(i)              
                                        sendTextTemplate(to,"🔹ᴍᴏʟᴇ ᴅᴜʟᴜ ʏᴀ ᴍᴀᴜ ɴʏᴜsᴜ" +h)
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in admin:
                                try:
                                    ...
                                    ko.sendMessage(msg.to,"Success!!!")
                                    jk.findAndAddContactsByMid(mid)
                                    jk.findAndAddContactsByMid(Amid)
                                    jk.findAndAddContactsByMid(Bmid)
                                    jk.findAndAddContactsByMid(Cmid)
                                    jk.findAndAddContactsByMid(Dmid)
                                    jk.findAndAddContactsByMid(Fmid)
                                    jk.findAndAddContactsByMid(Gmid)
                                    jk.findAndAddContactsByMid(Hmid)
                                    jk.findAndAddContactsByMid(Imid)
                                    jk.findAndAddContactsByMid(Jmid)
                                    jk.findAndAddContactsByMid(Zmid)
                                    jk.sendMessage(msg.to,"Success!!!")
                            ...
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                               # sendTextTemplate(msg.to, "🔹ɢᴏᴏᴅ ʙʏᴇ🔹\n       "+str(G.name))
